@echo off
echo ========================================
echo   DEPLOY FRONTEND - TIMEOUT FIX
echo ========================================
...
echo.
echo 2. Build du frontend avec timeout corrigé...
cd frontend
call npm run build
cd ..
...
echo.
echo ✅ SUCCÈS ! Frontend déployé avec timeout corrigé
echo 🌐 Le site devrait maintenant mieux gérer les timeouts API
echo.
pause
