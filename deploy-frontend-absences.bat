@echo off
echo ========================================
echo   DEPLOY FRONTEND - SYSTEME ABSENCES
echo ========================================
...
echo.
echo 2. Build du frontend avec les nouvelles fonctionnalités...
cd frontend
call npm run build
cd ..
...
echo.
echo ✅ SUCCÈS ! Frontend déployé sur OVH avec le système d'absences
echo 🌐 Le site est maintenant à jour avec les nouvelles fonctionnalités
echo.
pause
