...
const Constraints = () => {
  ...
  // Nouvelle fonction pour appliquer 6/7 jours de travail
  const applySixDaysWork = (employeeId) => {
    setConstraints(prev => {
      ...
      // Choisir un jour de repos (généralement le dimanche ou le lundi)
      const restDay = 'Dimanche'; // ou 'Lundi' selon la préférence
                ...
                <tr key={employee._id}>
                  <td style={{ fontWeight: 'bold' }}>
                    ...
                    <button
                      ...
                      style={{ fontSize: '0.7rem', padding: '0.25rem 0.5rem', marginTop: '0.25rem' }}
                      title="Appliquer 6 jours de travail (1 jour de repos)"
                    >
                      📅 6/7
                    </button>
                  </td>
