...
echo Version : 1.1.3 > VERSION.md
echo Date : %date:~-4,4%/%date:~-7,2%/%date:~-10,2% >> VERSION.md
echo Heure : %time:~0,2%:%time:~3,2%:%time:~6,2% >> VERSION.md
echo Commit : Fix contraintes et bouton 6/7 >> VERSION.md
echo Statut : ⏳ En cours de deploiement >> VERSION.md

echo 6. Commit des modifications...
git commit -m "Version 1.1.3 - Fix contraintes et bouton 6/7 - Date: %date:~-4,4%/%date:~-7,2%/%date:~-10,2% %time:~0,2%:%time:~3,2%"
