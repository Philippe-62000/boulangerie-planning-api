...
const authenticateEmployee = async (req, res, next) => {
  try {
    ...
    // Uniquement pour les tokens liés à une fiche Employee (connexion email salarie-connexion)
    ...
    req.user = {
      ...
      name: decoded.name,
      role: decoded.role,
      // employeeId = fiche Employee si présent ; sinon userId (token générique React « salarié »)
