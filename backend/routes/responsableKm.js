...
router.post('/import-bank-pdf', upload.single('file'), responsableKmController.importBankPdf);
router.post('/confirm-import-bank-pdf', responsableKmController.confirmImportBankPdf);
