@echo off
echo ========================================
echo 🔧 BUILD ET REMPLACEMENT FRONTEND
echo ========================================
echo.
...
echo ✅ Parameters.js - Interface alertes email
...
echo    - static/css/main.xxx.css (styles avec alertes email)
echo    - static/js/main.xxx.js (JavaScript avec interface alertes)
